...
var filterReplies = require('./no_replies');
var filterTags = require('./no_tags');
var filterLinks = require('./drop_links');
var blockedWord = require('./block_word');
...
console.log(`reacting to ${process.env.TWITTER_KEYWORD} / ${process.env.FREQUENCY}%`);
...
module.exports = function () {
  ...
  bridgeToStream
    .pipe(new blockedWord())
    .pipe(new filterReplies())
